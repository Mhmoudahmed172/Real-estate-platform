...
export function ServicesPage() {
  ...
  return <motion.div {...pageMotion}><PageContainer><PageHeader eyebrow="الخدمات" title="الخدمات" description="إدارة خدمات العقارات حسب property_id فقط كما يدعم OpenAPI." actions={<Button asChild className="rounded-full shadow-sm"><Link to="/services/new"><Plus aria-hidden="true" className="size-4" /> إضافة خدمة</Link></Button>} />
