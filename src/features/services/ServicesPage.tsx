...
export function ServicesPage() {
  ...
  const { propertiesQuery, vendorsQuery } = useServiceOptions(); const params = useMemo(() => ({ property_id: propertyId, ...pagination }), [pagination.page, pagination.page_size, propertyId]); const listQuery = useServicesPage(params);
