...
import type { PropertyOut, ServiceCreate, ServiceOut, ServiceUpdate, VendorOut } from "@/types/resources";

type Values = ServiceCreateValues & ServiceUpdateValues;

type ServiceFormProps = { mode: "create" | "edit"; service?: ServiceOut; properties: PropertyOut[]; vendors: VendorOut[]; onSubmit: (payload: ServiceCreate | ServiceUpdate) => Promise<void>; onCancelHref: string };
