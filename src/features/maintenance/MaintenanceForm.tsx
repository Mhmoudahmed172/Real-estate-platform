...
import { maintenancePriorities, maintenanceStatuses, type MaintenanceCreate, type MaintenanceOut, type MaintenanceUpdate, type PropertyOut, type VendorOut } from "@/types/resources";
