...
export function MaintenancePage() {
  ...
  return <motion.div {...pageMotion}><PageContainer><PageHeader eyebrow="الصيانة" title="بلاغات الصيانة" description="إدارة بلاغات الصيانة حسب العقار والحالة من OpenAPI." actions={<Button asChild className="rounded-full shadow-sm"><Link to="/maintenance/new"><Plus aria-hidden="true" className="size-4" /> بلاغ جديد</Link></Button>} />
