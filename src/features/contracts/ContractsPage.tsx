...
export function ContractsPage() {
  ...
  return <motion.div {...pageMotion}><PageContainer>
    <PageHeader eyebrow="إدارة العقود" title="العقود" description="قائمة العقود حسب فلاتر OpenAPI: العقار والمالك والمستأجر والحالة." actions={<Button asChild className="rounded-full shadow-sm"><Link to="/contracts/new"><Plus aria-hidden="true" className="size-4" /> إنشاء عقد</Link></Button>} />
